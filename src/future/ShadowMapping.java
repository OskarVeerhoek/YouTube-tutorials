...
public class ShadowMapping
{
    ...
    private int shadowWidth = 640;
    private int shadowHeight = 480;
    ...
    private void render() 
    {
        ...
        while (!Display.isCloseRequested())
        {
            ...
            glMatrixMode(GL_PROJECTION);
            glLoadIdentity();
            gluPerspective(40, (float)width / (float)height, 1.0F, 1000.0F);
            glMatrixMode(GL_MODELVIEW);
            glLoadIdentity();
            gluLookAt(cameraPos.get(0), cameraPos.get(1), cameraPos.get(2), 0.0F, 0.0F, 0.0F, 0.0F, 1.0F, 0.0F);
            //TODO Add cam.applyModelViewMatrix(true) here and remove the 2 lines above
            ...
            { 
                /* 
                 * If we dont have the ambient shadow extention,
                 * we will need to add an extra rendering pass.
                 */
    ...
    public void setupOpenGL()
    {
        ...
        /* Check to see if the maximum texture size is 
         * bigger than 2048. Performance drops too much 
         * if it much bigger than that.
         */
    ...
    /**
     * Checks the clients computer for the required capabilities, and 
     * updates the states accordingly.
     */
