...
// </editor-fold>
/**
 * Happy Easter everyone! Enjoy the cool lighting effects.
 *
...
public class HappyEaster {
     ...
     */
    public static Vector3f position = new Vector3f(2.19f, -1.36f, -11.45f);
    public static Vector3f lightPosition = new Vector3f(0.6f, 6.9f, 12.4f);
    /**
    ...
    public static void main(String[] args) {
        ...
        // <editor-fold defaultstate="collapsed" desc="standard display code">
        try {
            if (fullscreen) {
        ...
        // <editor-fold defaultstate="collapsed" desc="shader intiialization">
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("src/episode_25/pointlight.vert"));
            String line;
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("src/episode_25/pointlight.frag"));
            String line;
            while ((line = reader.readLine()) != null) {
        ...
        // <editor-fold defaultstate="collapsed" desc="display lists">
        ...
        glNewList(objectDisplayList, GL_COMPILE);
        {
            Model m = null;
            try {
                m = OBJLoader.loadModel(new File("src/episode_25/bunny.obj"));
        ...
        int eggDisplayList = glGenLists(1);
        glNewList(eggDisplayList, GL_COMPILE);
        {
            Model m = null;
            try {
                m = OBJLoader.loadModel(new File("src/episode_25/egg_crack.obj"));
            } catch (FileNotFoundException e) {
                e.printStackTrace();
                Display.destroy();
                System.exit(1);
...
//                glUseProgram(shaderProgram);
                ...
                glPushMatrix();
                glTranslatef(-5.5f, -1.5f, 3.5f);
                glCallList(eggDisplayList);
                glPopMatrix();
//                glUseProgram(0);
            }
            ...
            glLight(GL_LIGHT0, GL_POSITION, asFloatBuffer(new float[]{lightPosition.x, lightPosition.y, lightPosition.z, 1f}));
            ...
            while (Keyboard.next()) {
                ...
                if (Keyboard.isKeyDown(Keyboard.KEY_F11)) {
                    try {
                        ...
                        Logger.getLogger(HappyEaster.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
        ...
        glDeleteLists(eggDisplayList, 1);
